$(function(){
		...
		*/
		...
		/*
			sistema de slide da páginaindividual de cada carro
		...
		*/
		...
		function navigateSlider(){
			...
			$('.arrow-left-nav').click(function(){
				if(curIndex > 0){
					...
					// console.log("Chegamos até o começo");
				}
			});
		}
		...
		var directory = '/curso-full-stack/front-end/projetos/projeto_07-rm-veiculos-especiais/'
